...
public class lensLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__9", "T__10", "T__11", "T__12", "START", "END", "LET", "PRINT", "INPUT", 
			"IF", "ELSEIF", "ELSE", "FOR", "WHILE", "IN", "INT_TYPE", "FLOAT_TYPE", 
			"STRING_TYPE", "BOOL_TYPE", "STRING", "INT", "FLOAT", "VAR", "DUPONT", 
			"POINT2", "DOT2", "EQUALS", "P_N", "P_I", "C_N", "C_I", "BOOL", "COMENTARIO", 
			"WS"
		};
	}
